...
- `POST ${UNSTRUCTURED_API_BASE_URL}/mineru_with_images?return_txt=true` when `UNSTRUCTURED_API_BASE_URL` is a base URL.
- `POST ${UNSTRUCTURED_API_BASE_URL}?return_txt=true` when `UNSTRUCTURED_API_BASE_URL` already points to `/mineru_with_images`.
