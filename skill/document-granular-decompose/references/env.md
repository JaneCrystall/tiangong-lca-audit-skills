...
- `UNSTRUCTURED_API_BASE_URL`: API base URL, for example `https://your-unstructured-host:7770`. A full `/mineru_with_images` endpoint is also accepted.
...
# Or:
# export UNSTRUCTURED_API_BASE_URL="https://your-unstructured-host:7770/mineru_with_images"
